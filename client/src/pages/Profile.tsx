          ...
          <div className="lg:col-span-1">
            ...
            <Card data-testid="card-questionnaire">
              ...
              <CardContent className="space-y-4">
                ...
                {((questionnaireData && typeof questionnaireData === 'object' && 'exists' in questionnaireData && !questionnaireData.exists) || !questionnaireData) && ((latestResultData && typeof latestResultData === 'object' && 'result' in latestResultData && !latestResultData.result) || !latestResultData) ? (
                  <>
